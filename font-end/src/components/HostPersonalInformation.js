...
function UserPersonalInformation() {
  ...
  function saveInformation() {
    ...
    information.username = document.getElementById('account-information-edit-username').value;
    document.getElementById('account-information-display-username').innerHTML = information.username;
  }
